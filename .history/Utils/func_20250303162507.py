...
def inverse_distance_weighting2D(data, grid_points, x_col, y_col, o_col, power, max_points, min_points, search_radius):
    ...
    for row in grid_points.iterrows():
        ...
        if data_dist['dist'].min() == 0:
            ...
            if len(data_dist.loc[data_dist['dist'] < search_radius]) < min_points:
                ...
                print('The function has finished. The results are in the grid_points DataFrame in the column p.')
