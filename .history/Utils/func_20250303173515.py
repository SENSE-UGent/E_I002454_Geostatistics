...
def inverse_distance_weighting3D(data, grid_points, power, max_points, min_points, search_radii):
    ...
    if 'z' in data.columns and 'z' in grid_points.columns:
        ...
        data_full = data[['x', 'y', 'o']].values
        data_coords = data[['x', 'y']].values
        grid_coords = grid_points[['x', 'y']].values
        is_3d = False
